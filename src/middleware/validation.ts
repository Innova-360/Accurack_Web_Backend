...
const DEFAULT_MESSAGES = {
  USERNAME: {
    ...
    LENGTH: 'Username must be between 3 to 15 characters long',
...
// Username validation regex (3-15 characters, alphanumeric only)
...
export const validateBusinessEmail = (req: Request, res: Response, next: NextFunction) => {
...
// Export default messages for use in other files
